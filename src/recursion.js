...
var reverse = function(string) {
  ...
  return reversedString + reverse(string.slice(0, string.length - 1));
};


// 10. Write a function that determines if a string is a palindrome.
var palindrome = function(string) {
  // \s = regex for whitespace, g for global, + for contiguous occurrences
  ...
  var sliced = string.slice(1, last);
